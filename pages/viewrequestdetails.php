        ...
        <div class="modal-dialog">
             <div class="modal-content">
                ...
                <form method="post" action=action/submitoffer-action.php>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button> <!--Submit buttonkfkfkfkffkkfkfkfkfkfkfkfkfkfkfkfkffffffffffffffffffffffffffffffffffffffffffffffffffffffff-->
