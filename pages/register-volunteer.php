                    ...
                    <div class="p-5">
                        ...
                        <form class="user" method="post" action=action/register-volunteer-action.php>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input class="form-control form-control-user" type="number" id="phone" placeholder="Phone Number" name="phone">
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-6"><input class="form-control" id="dateofbirth" type="date" name="dateofbirth"></div>
                            </div>
